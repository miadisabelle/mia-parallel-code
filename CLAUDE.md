...
# Fork-specific guidance (miadisabelle/mia-parallel-code)

Shared project guidance lives in `AGENTS.md`, imported above from upstream. The sections below apply to this fork only.
